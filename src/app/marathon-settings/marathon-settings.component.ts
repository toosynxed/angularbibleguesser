...
@Component({
  selector: 'app-marathon-settings',
  templateUrl: './marathon-settings.component.html',
  styleUrls: ['./marathon-settings.component.css']
})
export class MarathonSettingsComponent implements OnInit {
  // Default settings
  settings = {
    rounds: 5,
    contextSize: 250,
